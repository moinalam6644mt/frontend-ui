...
const CommercialSell = ({ selectedName, handleAdvanceKey, handleButtonClick,handleMinMaxOption ,setChildMinValue,setChildMaxValue,handleCoverArea,covered }) => {
                  ...
                  <div style={{display:'inline-flex', background:'white', paddingTop:'5px',marginTop:'2px',position: 'absolute', right: '0',width: '700px',border: '1px solid #ddd',padding: '1rem', columnGap: '1rem'}}>
                    <div>
                      <ul className='list-group'>
                        ...
                        <li className='list-group-item' name='covered_Area' onClick={handleCoverArea}>Covered Area</li> 
