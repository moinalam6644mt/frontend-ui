...
const AmenitiesComponent = ({ setCheckedAmenities, handleShow, AddAmenitiesData, setpropertyId }) => {
  ...
  useEffect(() => {
    const checked = amenityData
      ...
      .map(amenity => ({ name: amenity.name, amenityId: amenity.amenity_id }));
            ...
            {amenityData.map((amenity, index) => (
              ...
              >
                <input
                  ...
                  onChange={() => changeAmenities(index, amenity.amenity_id)}
