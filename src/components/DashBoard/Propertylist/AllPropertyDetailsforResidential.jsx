...
const AllPropertyDetailsforResidential = ({ propertyData }) => {
            ...
            <div className="card-body">
              <div className="d-sm-flex project-details-title">
                <div className="flex-shrink-0 text-sm-end order-sm-2">
                  <h2 className="text-end">9000/Mo</h2>
                ...
                <div className="flex-grow-1 me-3 order-sm-1">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                      <a>{propertyData?.data?.property_for}</a>
                    </li>
                    <li className="breadcrumb-item">
                      <a>{propertyData?.data?.property_type}</a>
                    </li>
                    <li className="breadcrumb-item active" aria-current="page">
                      {propertyData?.data?.property_type_for}
                    </li>
                  </ol>
                  <h3>{`${propertyData?.data?.bedroom} BHK ${propertyData?.data?.property_type} ${propertyData?.data?.property_type_for} for Sale in ${propertyData?.data?.address}`}</h3>
                  <p className="mb-1">
                      ...
                      <ul className="list-info list-col-lg-4 list-property-feature">
                        ...
                        <li>
                          <div>
                            ...
                            Carpet Area:
                            <span>
                              <b>{propertyData?.data?.carpet_area}</b> sq ft
                            </span>
                          </div>
                        </li>
                        <li>
                          <div>
                            ...
                            Bathrooms:
                            <span>
                              <b>{propertyData?.data?.bathroom}</b>
                            </span>
                          </div>
                        </li>
                        <li>
                        ...
                        <li>
                          <div>
                            ...
                            Status:
                            <span>
                              <b>{propertyData?.data?.furnishing_status}</b>
                            </span>
                          </div>
                        </li>
                        <li>
                          <div>
                            ...
                            <span>
                              <b>
                                {propertyData?.data?.floor_no}(out of
                                {propertyData?.data?.total_floor_no})
                              </b>
                            </span>
                          </div>
                        </li>
          ...
          <div className="row">
                ...
                <div className="card-body">
                  <ul className="list-property-details">
                    ...
                    <li>
                      ...
                      <b>{propertyData?.data?.property_id}</b>
                    </li>
                    <li>
                      <img
                    ...
                    <li>
                      ...
                      <b>{propertyData?.data?.processing_status}</b>
                    </li>
                    <li>
                      <img
                      ...
                      <b>{propertyData?.data?.developer_detail}</b>
                    </li>
                    <li>
                      <img
                        src="http://localhost/realestate-live/public/images/icons/calendar.png"
                      ...
                      <b>{propertyData?.data?.project_details}</b>
                    </li>
                    <li>
                      <img
                        src="http://localhost/realestate-live/public/images/icons/calendar.png"
                    ...
                    <li>
                      ...
                      <b>{propertyData?.data?.expected_amt}</b>
                    </li>
                    <li>
                      <img
                      ...
                      <b>{propertyData?.data?.booking_amt}</b>
                    </li>
                    <li>
                      <img
                    ...
                    <li>
                      ...
                      />
                      <span>Parking</span>
                      <b>{propertyData?.data?.parking || 'not available'}</b>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <aside className="col-xl-3 col-lg-4 col-12">
              <div className="sticky-top mb-4">
                ...
                {userReview === true ? (
                  <UserReview
                    showUserReviewForm={showUserReviewForm}
...
export default AllPropertyDetailsforResidential;
